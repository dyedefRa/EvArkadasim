...
{
    [Authorize(EvArkadasimPermissions.Message.Default)]
    public class MessageAppService : CrudAppService<Message, MessageDto, int, PagedAndSortedResultRequestDto, MessageDto, MessageDto>, IMessageAppService
    {
        ...
        public MessageAppService(
            ...
            IStringLocalizer<EvArkadasimResource> L,
        ...
        /// </summary>
        /// <returns></returns>
        [Authorize(EvArkadasimPermissions.Message.See)]
            ...
            try
            {
                ...
                var viewModels = list
                    .Select(x =>
                    {
                        ...
                        _messageContentRepository.Where(x => x.SenderId == shownUser.Id).OrderByDescending(x => x.Id).FirstOrDefault().CreatedDate.ToMessageSendDateString(isUserLastSeen: true);
